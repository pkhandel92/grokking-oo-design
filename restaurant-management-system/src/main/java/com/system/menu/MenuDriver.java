...
public class MenuDriver {
    public static void main(String[] args) {
        ...
        MenuComponent iceCreamMenu=new Menu("IceCream Menu","Diner's menu for icecream");
        MenuComponent chocolateIceCream=new MenuItem(3.0,"Chocolate ice cream with mint chips","Chef's Special cream",true);
        iceCreamMenu.add(chocolateIceCream);
        menuComponent.add(friedChicken);
